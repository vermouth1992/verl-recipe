...
EXP_NAME=smol135m_ppo-1211a1-legacy-$use_legacy_worker_impl
...
python3 -m verl.trainer.main_ppo \
    ...
    critic.model.path=/home/chi-zhang/models/HuggingFaceTB_random_value \
    critic.model.enable_gradient_checkpointing=True \
    critic.ppo_max_token_len_per_gpu=5000 \
